!(function(e, t) {
    ...
    function w(e, t, n) {
        ...
        var r = new g(e)
        return t !== s && et(r, t), n !== s && tt(r, n), r
    }
    var O = {
    ...
    ***************************************************************************** */ var A = function() {
    ...
    var H = {
            ...
            array: function(e, t) {
                ...
                var n = M(t)
                return Bt(e, K(n), n.name)
            },
            map: function(e, t) {
                arguments.length > 2 && J("map")
                var n = M(t)
                return new Ht(e, K(n), n.name)
            },
            set: function(e, t) {
                arguments.length > 2 && J("set")
                var n = M(t)
                return new Xt(e, K(n), n.name)
            },
    ...
    var X,
        Y,
        F = P(!1, function(e, t, n, r, o) {
            var i = n.get,
                a = n.set,
                s = o[0] || {}
            $t(e).addComputedProp(e, t, A({ get: i, set: a, context: e }, s))
        }),
    ...
    var we = (function(e) {
            ...
            return (
                ...
                (t.prototype.prepareNewValue = function(e) {
                    if ((ne(this), Rt(this))) {
                        var t = It(this, { object: this, type: "update", newValue: e })
                ...
                (t.prototype.setNewValue = function(e) {
                    ...
                    ;(this.value = e),
                        this.reportChanged(),
                        Pt(this) &&
                            Nt(this, { type: "update", object: this, newValue: e, oldValue: t })
                }),
    ...
    var Le = (function() {
        ...
        return (
            ...
            (t.prototype.schedule = function() {
                this._isScheduled ||
                    ((this._isScheduled = !0), Re.pendingReactions.push(this), Ge())
            }),
            ...
            (t.prototype.runReaction = function() {
                if (!this.isDisposed) {
                    if ((ke(), (this._isScheduled = !1), te(this))) {
            ...
            (t.prototype.dispose = function() {
                this.isDisposed ||
                    ((this.isDisposed = !0), this._isRunning || (ke(), oe(this), Ne()))
            }),
    ...
    function Ge() {
        Re.inBatch > 0 || Re.isRunningReactions || Ue(qe)
    }
    function qe() {
        Re.isRunningReactions = !0
        var e = Re.pendingReactions,
            t = 0
        for (
            e.length > 0 &&
            (0 === Me &&
    ...
    function nt(e, t, n, r) {
        var i = "function" == typeof r ? rn(t, n) : rn(t),
    ...
    function rt(e, t, n, r) {
        var o = ot((r = M(r)))
        return I(e), $t(e, r.name, o.enhancer), t && it(e, t, n, o), e
    }
    function ot(e) {
    ...
    function pt(e) {
        return arguments.length > 1 ? o(!1) : ht(e)
    }
    function dt(e, t) {
        return (
            null != e &&
            (void 0 !== t
                ? !!nn(e) && e[b].values.has(t)
                : nn(e) || !!e[b] || m(e) || ze(e) || Ae(e))
        )
    }
    function vt(e) {
        return 1 !== arguments.length && o(!1), dt(e)
    }
    function yt(e) {
        return nn(e)
            ? e[b].getKeys()
    ...
    function bt(e, t, n) {
        if (2 !== arguments.length || Yt(e))
            if (nn(e)) {
                var r = e[b],
                    a = r.values.get(t)
                a ? r.write(t, n) : r.addObservableProp(t, n, r.defaultEnhancer)
            } else if (Wt(e)) e.set(t, n)
            else if (Yt(e)) e.add(t)
            else {
                if (!qt(e)) return o(!1)
    ...
    var mt = { detectCycles: !0, exportMapsAsObjects: !0, recurseEverything: !1 }
    function wt(e, t, n, r) {
    ...
    var jt = {
        ...
        set: function(e, t, n) {
            return !!Dt(t) && (bt(e, t, n), !0)
        },
        deleteProperty: function(e, t) {
            return !!Dt(t) && (xt(e).remove(t), !0)
        },
        ownKeys: function(e) {
    ...
    var Vt = {
        ...
        set: function(e, t, n) {
            return (
                ...
                "number" == typeof t && Mt.set.call(e, t, n),
                "symbol" == typeof t || isNaN(t) ? (e[t] = n) : Mt.set.call(e, parseInt(t), n),
                !0
            )
        },
        preventExtensions: function(e) {
                    ...
                    var r = !this.owned && !1,
                        ...
                        i =
                            o || r
                                ...
                                : null
                    this.atom.reportChanged(), o && Nt(this, i)
                }),
        ...
        Mt = {
            ...
            set: function(e, t) {
                ...
                if (e < r.length) {
                    ...
                    var o = r[e]
                    if (Rt(n)) {
                        var i = It(n, { type: "update", object: n.proxy, index: e, newValue: t })
                        if (!i) return
                        t = i.newValue
                    }
    ...
    var Ut,
        Gt = f("ObservableArrayAdministration", Lt)
    function qt(e) {
        return u(e) && Gt(e[b])
    }
    var zt,
        ...
        Ht = (function() {
            ...
            return (
                ...
                (e.prototype.delete = function(e) {
                    var t = this
                    if (
                        (ne(this._keysAtom), Rt(this)) &&
                        !(r = It(this, { type: "delete", object: this, name: e }))
                    )
                        return !1
                    if (this._has(e)) {
                        var n = Pt(this),
                ...
                (e.prototype._addValue = function(e, t) {
                    ...
                    var r = Pt(this)
                    r && Nt(this, r ? { type: "add", object: this, name: e, newValue: t } : null)
                }),
                ...
                (e.prototype[((Ut = b), Symbol.iterator)] = function() {
                    return this.entries()
                }),
        ...
        Xt = (function() {
            ...
            return (
                ...
                (e.prototype.add = function(e) {
                    var t = this
                    if (
                        (ne(this._atom), Rt(this)) &&
                        !(r = It(this, { type: "add", object: this, newValue: e }))
                    )
                        return this
                    if (!this.has(e)) {
                        At(function() {
                ...
                (e.prototype.delete = function(e) {
                    var t = this
                    if (Rt(this) && !(r = It(this, { type: "delete", object: this, oldValue: e })))
                        return !1
                    if (this.has(e)) {
                        var n = Pt(this),
                ...
                (e.prototype[((zt = b), Symbol.iterator)] = function() {
                    return this.values()
                }),
                e
            )
        })(),
        Yt = f("ObservableSet", Xt),
        Ft = (function() {
            function e(e, t, n, r) {
                void 0 === t && (t = new Map()),
                    (this.target = e),
                ...
                (e.prototype.notifyPropertyAddition = function(e, t) {
                    var n = Pt(this),
                        r = n
                            ...
                            : null
                    if ((n && Nt(this, r), this.pendingKeys)) {
    ...
    var tn = f("ObservableObjectAdministration", Ft)
    function nn(e) {
        return !!u(e) && (I(e), tn(e[b]))
    }
    function rn(e, t) {
        if ("object" == typeof e && null !== e) {
            if (qt(e)) return void 0 !== t && o(!1), e[b].atom
            if (Yt(e)) return e[b]
            if (Wt(e)) {
                var n = e
                return void 0 === t
            ...
            var r
            if ((I(e), t && !e[b] && e[t], nn(e)))
                return t ? ((r = e[b].values.get(t)) || o(!1), r) : o(!1)
            if (m(e) || Ae(e) || ze(e)) return e
        } else if ("function" == typeof e && ze(e[b])) return e[b]
        return o(!1)
    }
    function on(e, t) {
        return (
    ...
    function an(e, t) {
        return (void 0 !== t ? rn(e, t) : nn(e) || Wt(e) || Yt(e) ? on(e) : rn(e)).name
    }
        ...
        return (
            ...
            (function e(t, n, r, o, i) {
                ...
                if ((o.push(t), i.push(n), u)) {
                    ...
                    for (; f--; )
                        if (((p = h[f]), !ln(n, p) || !e(t[p], n[p], r - 1, o, i))) return !1
                }
    ...
    "object" == typeof __MOBX_DEVTOOLS_GLOBAL_HOOK__ &&
        ...
        (e.flow = function(e) {
            ...
            return function() {
                var n,
                    ...
                    o = arguments,
                    i = ++ct,
                    a = Ye(t + " - runid: " + i + " - init", e).apply(r, o),
                    u = void 0,
                    c = new Promise(function(e, r) {
                        ...
                        function s(e) {
                            ...
                            u = void 0
                            try {
                                n = Ye(t + " - runid: " + i + " - yield " + o++, a.next).call(a, e)
                            } catch (e) {
                                return r(e)
                            }
                            l(n)
                        ...
                        function c(e) {
                            ...
                            u = void 0
                            try {
                                n = Ye(t + " - runid: " + i + " - yield " + o++, a.throw).call(a, e)
                            } catch (e) {
                                return r(e)
                            }
                            l(n)
                ...
                return (
                    (c.cancel = Ye(t + " - runid: " + i + " - cancel", function() {
                        try {
                            u && ft(u)
                            var e = a.return(void 0),
                                t = Promise.resolve(e.value)
                            t.then(s, s), ft(t), n(new lt())
                        } catch (e) {
                            n(e)
                        }
                    })),
        ...
        (e.get = function(e, t) {
            if (gt(e, t)) return nn(e) ? e[t] : Wt(e) ? e.get(t) : qt(e) ? e[t] : o(!1)
        }),
        (e.getAtom = rn),
        (e.getDebugName = an),
        (e.getDependencyTree = at),
        ...
        (e.intercept = function(e, t, n) {
            return "function" == typeof n
                ? (function(e, t, n) {
                      return on(e, t).intercept(n)
                  })(e, t, n)
                : (function(e, t) {
                      return on(e).intercept(t)
                  })(e, t)
        }),
        ...
        (e.isComputedProp = function(e, t) {
            return "string" != typeof t ? o(!1) : ht(e, t)
        }),
        (e.isFlowCancellationError = function(e) {
            return e instanceof lt
        }),
        (e.isObservable = vt),
        (e.isObservableArray = qt),
        (e.isObservableMap = Wt),
        (e.isObservableObject = nn),
        (e.isObservableProp = function(e, t) {
            return "string" != typeof t ? o(!1) : dt(e, t)
        }),
        (e.isObservableSet = Yt),
        (e.keys = yt),
        (e.observable = W),
        ...
        (e.onBecomeObserved = et),
        (e.onBecomeUnobserved = tt),
        ...
        (e.remove = function(e, t) {
            if (nn(e)) e[b].remove(t)
            else if (Wt(e)) e.delete(t)
            else if (Yt(e)) e.delete(t)
            else {
                if (!qt(e)) return o(!1)
                "number" != typeof t && (t = parseInt(t, 10)),
                    i(t >= 0, "Not a valid index: '" + t + "'"),
        ...
        (e.toJS = function(e, t) {
            ...
            return (
                ...
                (function e(t, n, r) {
                    if (!n.recurseEverything && !vt(t)) return t
                    if ("object" != typeof t) return t
                    if (null === t) return null
                    if (t instanceof Date) return t
                    if (Oe(t)) return e(t.get(), n, r)
                    if ((vt(t) && yt(t), !0 === n.detectCycles && null !== t && r.has(t)))
                        return r.get(t)
                    ...
                    if (Yt(t) || Object.getPrototypeOf(t) === Set.prototype) {
                        if (!1 === n.exportMapsAsObjects) {
                            var u = wt(r, t, new Set(), n)
                            return (
                    ...
                    if (Wt(t) || Object.getPrototypeOf(t) === Map.prototype) {
                        if (!1 === n.exportMapsAsObjects) {
                            var l = wt(r, t, new Map(), n)
                            return (
