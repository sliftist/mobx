        ...
        return (
            ...
            (e.prototype.reportChanged = function() {
                ke(),
                    ...
                    Ce.queueReportChangedEndBatchAsMicrotask
...
function m(e, t, r) {
    ...
    var n = new b(e)
    return t !== a && Qe(n, t), r !== a && Ze(n, r), n
}
var w = {
...
function z(e) {
    return e.defaultDecorator ? e.defaultDecorator.enhancer : !1 === e.deep ? N : P
}
var K = {
        box: function(e, t) {
        ...
        array: function(e, t) {
            ...
            var r = L(t)
            return Nt(e, z(r), r.name)
        },
        map: function(e, t) {
            arguments.length > 2 && W("map")
            var r = L(t)
            return new zt(e, z(r), r.name)
        },
        set: function(e, t) {
            arguments.length > 2 && W("set")
            var r = L(t)
            return new Wt(e, z(r), r.name)
        },
...
var J,
    ...
    Y = I(!1, function(e, t, r, n, o) {
        var i = r.get,
            a = r.set,
            s = o[0] || {}
        Yt(e).addComputedProp(e, t, O({ get: i, set: a, context: e }, s))
    }),
...
var me = (function(e) {
        ...
        return (
            ...
            (t.prototype.setNewValue = function(e) {
                ...
                ;(this.value = e),
                    this.reportChanged(),
                    Tt(this) && kt(this, { type: "update", object: this, newValue: e, oldValue: t })
            }),
...
var Be = (function() {
    ...
    return (
        ...
        (e.prototype.schedule = function() {
            this._isScheduled || ((this._isScheduled = !0), Ce.pendingReactions.push(this), Me())
        }),
        ...
        (e.prototype.runReaction = function() {
            if (!this.isDisposed) {
                if ((ke(), (this._isScheduled = !1), ee(this))) {
        ...
        (e.prototype.dispose = function() {
            this.isDisposed || ((this.isDisposed = !0), this._isRunning || (ke(), ne(this), Pe()))
        }),
...
function Me() {
    Ce.inBatch > 0 || Ce.isRunningReactions || Le(Ue)
}
function Ue() {
...
Je.bound = function(e, t, r, n) {
    return !0 === n
        ...
        ? {
              ...
              enumerable: !1,
              get: function() {
                  return Xe(this, t, r.value || r.initializer.call(this)), this[t]
              },
              set: Ke
          }
        : {
...
function Qe(e, t, r) {
    return et("onBecomeObserved", e, t, r)
}
function Ze(e, t, r) {
    return et("onBecomeUnobserved", e, t, r)
}
function et(e, t, r, o) {
    var i = "function" == typeof o ? tr(t, r) : tr(t),
...
function tt(e, t, r, n) {
    var o = rt((n = L(n)))
    return T(e), Yt(e, n.name, o.enhancer), t && nt(e, t, r, o), e
}
function rt(e) {
...
function ft(e) {
    return arguments.length > 1 ? n(!1) : lt(e)
}
function pt(e, t) {
    return (
        null != e &&
        (void 0 !== t ? !!er(e) && e[y].values.has(t) : er(e) || !!e[y] || g(e) || Ge(e) || Oe(e))
    )
}
function ht(e) {
    return 1 !== arguments.length && n(!1), pt(e)
}
function dt(e) {
    return er(e)
        ? e[y].getKeys()
...
function vt(e, t, r) {
    if (2 !== arguments.length || Jt(e))
        if (er(e)) {
            var i = e[y],
                a = i.values.get(t)
            a ? i.write(t, r) : i.addObservableProp(t, r, i.defaultEnhancer)
        } else if (Kt(e)) e.set(t, r)
        else if (Jt(e)) e.add(t)
        else {
            if (!Ut(e)) return n(!1)
...
var bt = { detectCycles: !0, exportMapsAsObjects: !0, recurseEverything: !1 }
function gt(e, t, r, n) {
...
var Et = {
    ...
    get: function(e, t) {
        ...
        return _t(t) && r.has(t), e[t]
    },
    set: function(e, t, r) {
        return !!_t(t) && (vt(e, t, r), !0)
    },
    deleteProperty: function(e, t) {
        return !!_t(t) && (At(e).remove(t), !0)
    },
    ownKeys: function(e) {
    ...
    get: function(e, t) {
        return t === y
            ...
            ? Bt.hasOwnProperty(t)
                ? Bt[t]
                : e[t]
            : Bt.get.call(e, parseInt(t))
    },
    set: function(e, t, r) {
        return (
            "length" === t && e[y].setArrayLength(r),
            "number" == typeof t && Bt.set.call(e, t, r),
            "symbol" == typeof t || isNaN(t) ? (e[t] = r) : Bt.set.call(e, parseInt(t), r),
            !0
        )
    },
    preventExtensions: function(e) {
    ...
    Bt = {
        ...
        set: function(e, t) {
            ...
            if (e < n.length) {
                ...
                var o = n[e]
                if (jt(r)) {
                    var i = Rt(r, { type: "update", object: r.proxy, index: e, newValue: t })
                    if (!i) return
                    t = i.newValue
                }
...
var Lt,
    Mt = l("ObservableArrayAdministration", Vt)
function Ut(e) {
    return s(e) && Mt(e[y])
}
var Gt,
    ...
    zt = (function() {
        ...
        return (
            ...
            (e.prototype.delete = function(e) {
                var t = this
                if (
                    (te(this._keysAtom), jt(this)) &&
                    !(n = Rt(this, { type: "delete", object: this, name: e }))
                )
                    return !1
                if (this._has(e)) {
                    var r = Tt(this),
            ...
            (e.prototype[((Lt = y), Symbol.iterator)] = function() {
                return this.entries()
            }),
    ...
    Wt = (function() {
        ...
        return (
            ...
            (e.prototype.add = function(e) {
                var t = this
                if (
                    (te(this._atom), jt(this)) &&
                    !(n = Rt(this, { type: "add", object: this, newValue: e }))
                )
                    return this
                if (!this.has(e)) {
                    xt(function() {
            ...
            (e.prototype.delete = function(e) {
                var t = this
                if (jt(this) && !(n = Rt(this, { type: "delete", object: this, oldValue: e })))
                    return !1
                if (this.has(e)) {
                    var r = Tt(this),
            ...
            (e.prototype[((Gt = y), Symbol.iterator)] = function() {
                return this.values()
            }),
            e
        )
    })(),
    Jt = l("ObservableSet", Wt),
    Xt = (function() {
        function e(e, t, r, n) {
            void 0 === t && (t = new Map()),
                (this.target = e),
        ...
        return (
            ...
            (e.prototype.addObservableProp = function(e, t, r) {
                ...
                var n = this.target
                if (jt(this)) {
                    var o = Rt(this, { object: this.proxy || n, name: e, type: "add", newValue: t })
                    if (!o) return
                    t = o.newValue
                }
            ...
            (e.prototype.remove = function(e) {
                if (this.values.has(e)) {
                    var t = this.target
                    if (jt(this))
                        if (!(a = Rt(this, { object: this.proxy || t, name: e, type: "remove" })))
                            return
                    try {
                        ke()
                        var r = Tt(this),
...
var Zt = l("ObservableObjectAdministration", Xt)
function er(e) {
    return !!s(e) && (T(e), Zt(e[y]))
}
function tr(e, t) {
    if ("object" == typeof e && null !== e) {
        if (Ut(e)) return void 0 !== t && n(!1), e[y].atom
        if (Jt(e)) return e[y]
        if (Kt(e)) {
            var r = e
            return void 0 === t
        ...
        var o
        if ((T(e), t && !e[y] && e[t], er(e)))
            return t ? ((o = e[y].values.get(t)) || n(!1), o) : n(!1)
        if (g(e) || Oe(e) || Ge(e)) return e
    } else if ("function" == typeof e && Ge(e[y])) return e[y]
    return n(!1)
}
function rr(e, t) {
    return (
...
function nr(e, t) {
    return (void 0 !== t ? tr(e, t) : er(e) || Kt(e) || Jt(e) ? rr(e) : tr(e)).name
}
    ...
    return (
        ...
        (function e(t, r, n, o, i) {
            ...
            if ((o.push(t), i.push(r), u)) {
                ...
                for (; f--; ) if (((h = p[f]), !sr(r, h) || !e(t[h], r[h], n - 1, o, i))) return !1
            }
...
"object" == typeof __MOBX_DEVTOOLS_GLOBAL_HOOK__ &&
    __MOBX_DEVTOOLS_GLOBAL_HOOK__.injectMobx({ spy: ze, extras: { getDebugName: nr }, $mobx: y }),
    (exports.$mobx = y),
    (exports.FlowCancellationError = ut),
    (exports.ObservableMap = zt),
    (exports.ObservableSet = Wt),
    (exports.Reaction = Be),
    ...
    (exports.configure = function(e) {
        ...
        if (
            ...
            ;(Ce.enforceActions = c),
                (Ce.allowStateChanges = !0 !== c && "strict" !== c),
                (Ce.queueReportChangedEndBatchAsMicrotask = !0)
        }
    ...
    (exports.flow = function(e) {
        ...
        return function() {
            var r,
                ...
                o = arguments,
                i = ++st,
                s = Je(t + " - runid: " + i + " - init", e).apply(n, o),
                u = void 0,
                c = new Promise(function(e, n) {
                    ...
                    function a(e) {
                        ...
                        u = void 0
                        try {
                            r = Je(t + " - runid: " + i + " - yield " + o++, s.next).call(s, e)
                        } catch (e) {
                            return n(e)
                        }
                        l(r)
                    ...
                    function c(e) {
                        ...
                        u = void 0
                        try {
                            r = Je(t + " - runid: " + i + " - yield " + o++, s.throw).call(s, e)
                        } catch (e) {
                            return n(e)
                        }
                        l(r)
            ...
            return (
                (c.cancel = Je(t + " - runid: " + i + " - cancel", function() {
                    try {
                        u && ct(u)
                        var e = s.return(void 0),
                            t = Promise.resolve(e.value)
                        t.then(a, a), ct(t), r(new ut())
                    } catch (e) {
                        r(e)
                    }
                })),
    ...
    (exports.get = function(e, t) {
        if (yt(e, t)) return er(e) ? e[t] : Kt(e) ? e.get(t) : Ut(e) ? e[t] : n(!1)
    }),
    (exports.getAtom = tr),
    (exports.getDebugName = nr),
    (exports.getDependencyTree = ot),
    ...
    (exports.intercept = function(e, t, r) {
        return "function" == typeof r
            ? (function(e, t, r) {
                  return rr(e, t).intercept(r)
              })(e, t, r)
            : (function(e, t) {
                  return rr(e).intercept(t)
              })(e, t)
    }),
    ...
    (exports.isComputed = ft),
    (exports.isComputedProp = function(e, t) {
        return "string" != typeof t ? n(!1) : lt(e, t)
    }),
    (exports.isFlowCancellationError = function(e) {
        return e instanceof ut
    }),
    (exports.isObservable = ht),
    (exports.isObservableArray = Ut),
    (exports.isObservableMap = Kt),
    (exports.isObservableObject = er),
    (exports.isObservableProp = function(e, t) {
        return "string" != typeof t ? n(!1) : pt(e, t)
    }),
    (exports.isObservableSet = Jt),
    (exports.keys = dt),
    (exports.observable = H),
    (exports.observe = function(e, t, r, n) {
        return "function" == typeof r
            ? (function(e, t, r, n) {
                  return rr(e, t).observe(r, n)
              })(e, t, r, n)
            : (function(e, t, r) {
                  return rr(e).observe(t, r)
              })(e, t, r)
    }),
    (exports.onBecomeObserved = Qe),
    (exports.onBecomeUnobserved = Ze),
    ...
    (exports.remove = function(e, t) {
        if (er(e)) e[y].remove(t)
        else if (Kt(e)) e.delete(t)
    ...
    (exports.toJS = function(e, t) {
        ...
        return (
            ...
            (function e(t, r, n) {
                if (!r.recurseEverything && !ht(t)) return t
                if ("object" != typeof t) return t
                if (null === t) return null
                if (t instanceof Date) return t
                if (we(t)) return e(t.get(), r, n)
                if ((ht(t) && dt(t), !0 === r.detectCycles && null !== t && n.has(t)))
                    return n.get(t)
                ...
                if (Jt(t) || Object.getPrototypeOf(t) === Set.prototype) {
                    if (!1 === r.exportMapsAsObjects) {
                        var u = gt(n, t, new Set(), r)
                        return (
                ...
                if (Kt(t) || Object.getPrototypeOf(t) === Map.prototype) {
                    if (!1 === r.exportMapsAsObjects) {
                        var l = gt(n, t, new Map(), r)
                        return (
    ...
    (exports.when = function(e, t, r) {
        return 1 === arguments.length || (t && "object" == typeof t) ? St(e, t) : Ot(e, t, r || {})
    })
